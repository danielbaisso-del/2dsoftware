...
const Hero: React.FC = () => {
  return (
    <section className="relative min-h-screen flex items-center pt-20 px-6 overflow-hidden">
      <div className="container mx-auto grid lg:grid-cols-[0.5fr_0.5fr] gap-16 items-center relative z-10">
        <motion.div
        ...
        >
          ...
          <motion.div
            ...
            className="relative hidden lg:flex justify-end w-full lg:pl-6"
          >
            <div className="relative z-10 p-3 glass rounded-[48px] shadow-2xl overflow-visible group border-transparent">
              <div className="absolute inset-0 bg-gradient-to-tr from-blue-500/8 via-transparent to-purple-500/8 opacity-50 transition-opacity duration-700" />
              <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.45 }} className="rounded-[20px] w-full lg:w-[560px] lg:min-w-[420px] mx-auto bg-gradient-to-br from-slate-800 to-slate-900 flex items-stretch p-4">
                <div className="w-full flex items-center justify-center">
                  <div className="w-full rounded-[14px] bg-[#071032] border border-transparent p-4 flex flex-col min-h-[420px] md:min-h-[460px]">
                    <div className="flex items-center gap-2 mb-4">
                      <span className="w-3 h-3 rounded-full bg-red-500" />
                      <span className="w-3 h-3 rounded-full bg-amber-400" />
                      <span className="w-3 h-3 rounded-full bg-emerald-400" />
                      <div className="ml-3 text-xs text-slate-400">Terminal — 2d-software</div>
                    </div>
                    <div className="flex-1 overflow-auto pr-2">
                      <pre className="font-mono text-base md:text-lg text-green-300 leading-7 whitespace-pre-wrap">
                        <TerminalAnimation />
                      </pre>
                    </div>
                  </div>
            ...
            <div className="absolute -top-10 -right-10 w-48 h-48 bg-blue-200/50 blur-[80px] rounded-full animate-pulse" />
          </motion.div>
      </div>
